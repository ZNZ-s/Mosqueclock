...
ucMosqueName		: 'جامع العباد', 
ucNowCityCODE		: 'OM.Alkhabora',                  // رمز المدينة الحالية (المدينة المنورة)                                   
...
ucUserThemeBG		: 6,                            // رقم سمة الخلفية المختارة (من 0 إلى 39)                                  
...
ucAzkarSabahOn		: 0,							// تفعيل أذكار الصباح (0 معطل، 1 مفعل)                                                        
ucAzkarAsrOn		: 0,                            // تفعيل أذكار العصر (0 معطل، 1 مفعل)                                                         
ucAzkarMaghribOn	: 0,                            // تفعيل أذكار المغرب (0 معطل، 1 مفعل)                                                        
ucAzkarIshaOn		: 0,                            // تفعيل أذكار العشاء (0 معطل، 1 مفعل)                                                        
ucCounterLastMinute	: 1,                            // عرض العد التنازلي في الدقيقة الأخيرة (0 معطل، 1 مفعل)                                      
ucFullScreenCounter	: 1,                            // عرض العد التنازلي في وضع ملء الشاشة (0 معطل، 1 مفعل)                                       
...
ucAzkarActive		: 0,                            // تفعيل الأذكار (0 معطل، 1 مفعل)                                                             
ucSlidesActive		: 0,                            // تفعيل الشرائح (0 معطل، 1 مفعل)                                                             
ucIqamaFullTimes	: 1,                            // عرض أوقات الإقامة الكاملة (0 معطل، 1 مفعل)                                                 
...
ucIqamaFAJR			: 20,                           // وقت الإقامة بعد الأذان للفجر بالدقائق                                                     
ucIqamaSHRQ			: 15,							// وقت الإقامة بعد الأذان للشروق بالدقائق                   
ucIqamaDOHR			: 25,                           // وقت الإقامة بعد الأذان للظهر بالدقائق                    
ucIqamaASSR			: 25,                           // وقت الإقامة بعد الأذان للعصر بالدقائق                    
ucIqamaMGRB			: 10,                           // وقت الإقامة بعد الأذان للمغرب بالدقائق                   
ucIqamaISHA			: 25,                           // وقت الإقامة بعد الأذان للعشاء بالدقائق                   
...
ucMeteoLatitude		: 23.9628375,                   // خط العرض المستخدم لمعلومات الطقس                        
ucMeteoLongitude	: 57.095682,                   // خط الطول المستخدم لمعلومات الطقس                        
ucWcsvIsActive		: 0,                            // تفعيل ملف WCSV (0 معطل، 1 مفعل)                           
ucPsFlag			: 0,                            // علم فلسطين (0 معطل، 1 مفعل)                               
